...
export const COUNTRIES: Country[] = [
  ...
  { code: "GR", name: "Greece" }, { code: "GS", name: "South Georgia" },
  { code: "GT", name: "Guatemala" }, { code: "GU", name: "Guam" },
  { code: "GW", name: "Guinea-Bissau" }, { code: "GY", name: "Guyana" },
  { code: "HK", name: "Hong Kong" }, { code: "HM", name: "Heard & McDonald Islands" },
  ...
  { code: "MF", name: "Saint Martin" }, { code: "MG", name: "Madagascar" },
  ...
  { code: "PN", name: "Pitcairn Islands" }, { code: "PR", name: "Puerto Rico" },
  ...
  { code: "SX", name: "Sint Maarten" }, { code: "SY", name: "Syria" },
  ...
  { code: "TR", name: "Türkiye" }, { code: "TT", name: "Trinidad and Tobago" },
  { code: "TV", name: "Tuvalu" }, { code: "TW", name: "Taiwan" },
  { code: "TZ", name: "Tanzania" }, { code: "UA", name: "Ukraine" },
  { code: "UG", name: "Uganda" }, { code: "UM", name: "U.S. Minor Outlying Islands" },
  { code: "US", name: "United States" }, { code: "UY", name: "Uruguay" },
  { code: "UZ", name: "Uzbekistan" }, { code: "VA", name: "Vatican City" },
  { code: "VC", name: "Saint Vincent and the Grenadines" }, { code: "VE", name: "Venezuela" },
  { code: "VG", name: "British Virgin Islands" }, { code: "VI", name: "U.S. Virgin Islands" },
  ...
  { code: "ZW", name: "Zimbabwe" }, { code: "XK", name: "Kosovo" },
];

export const LARGE_COUNTRIES = new Set(["US", "CN", "IN", "RU", "BR", "ID", "MX", "JP", "DE", "GB"]);
